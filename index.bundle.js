...
const domInterfacer = (() => {
    ...
    function createAllProjectsPage(projectStructurer){
        ...
        Object.values(projectStructurer.container).forEach((project) => {
            ...
            const div = domFunctions.createDiv([_selectorHolder__WEBPACK_IMPORTED_MODULE_2__.selectorHolder.list, project.containType])
    ...
    function getListInterface(listContainer){
        ...
        const addPopupBtn = listContainer.querySelector(`.${_selectorHolder__WEBPACK_IMPORTED_MODULE_2__.selectorHolder.addPopup}.${_selectorHolder__WEBPACK_IMPORTED_MODULE_2__.selectorHolder.addBtn}`)
        return {
    ...
    function getLiInterface(li){
        const liIcon = li.querySelector(`.${_selectorHolder__WEBPACK_IMPORTED_MODULE_2__.selectorHolder.liIcon}`)
        const removeIcon = li.querySelector(`.${_selectorHolder__WEBPACK_IMPORTED_MODULE_2__.selectorHolder.removeLiIcon}`)
...
function createDomListFunctions() {
    ...
    function createListElement(object) {
        ...
        const elemIcon = domFunctions.createImg([_selectorHolder__WEBPACK_IMPORTED_MODULE_1__.selectorHolder.liIcon, object.type], object.icon, "16", "16")
        const span = document.createElement("span")
        span.innerText = object.title
        const rightLi = domFunctions.createDiv([_selectorHolder__WEBPACK_IMPORTED_MODULE_1__.selectorHolder.rightLi, object.type])
        const removeIcon = domFunctions.createImg([_selectorHolder__WEBPACK_IMPORTED_MODULE_1__.selectorHolder.removeLiIcon], _images_remove_task_png__WEBPACK_IMPORTED_MODULE_2__, "16", "16")
    ...
    function finishTodo(li){
        ...
        li.querySelector(`.${_selectorHolder__WEBPACK_IMPORTED_MODULE_1__.selectorHolder.liIcon}`).src = _images_finished_task_png__WEBPACK_IMPORTED_MODULE_3__
    }

    function unfinishTodo(li){
        li.classList.remove(`${_selectorHolder__WEBPACK_IMPORTED_MODULE_1__.selectorHolder.done}`)
        li.querySelector(`.${_selectorHolder__WEBPACK_IMPORTED_MODULE_1__.selectorHolder.liIcon}`).src = _images_unfinished_task_png__WEBPACK_IMPORTED_MODULE_4__
    }
    ...
    function createTodoListElement(baseObject) {
        ...
        const rightLi = li.querySelector(`.${_selectorHolder__WEBPACK_IMPORTED_MODULE_1__.selectorHolder.rightLi}.${_selectorHolder__WEBPACK_IMPORTED_MODULE_1__.selectorHolder.todo}`)
    ...
    function createList(object) {
        const div = domFunctions.createDiv([_selectorHolder__WEBPACK_IMPORTED_MODULE_1__.selectorHolder.list, object.containType])
        const ul = document.createElement("ul")
...
/* harmony import */ var _object_manipulator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./object-manipulator */ "./src/js/object-manipulator.js");



const listController = (() => {
    function setListEventListeners(listContainer, createFunction, setupFunction) {
        const listInterface = _dom_interfacer__WEBPACK_IMPORTED_MODULE_0__.domInterfacer.getListInterface(listContainer)
        ...
        listInterface.addPopupBtn.addEventListener("click", () => {
            const object = _object_manipulator__WEBPACK_IMPORTED_MODULE_1__.objectManipulator.createObject(listInterface.addPopup, createFunction)
            _object_manipulator__WEBPACK_IMPORTED_MODULE_1__.objectManipulator.addObject(object, listInterface.ul, setupFunction)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "objectManipulator": () => (/* binding */ objectManipulator)
/* harmony export */ });
/* harmony import */ var _dom_interfacer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom-interfacer */ "./src/js/dom-interfacer.js");
...
/* harmony import */ var _list_controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./list-controller */ "./src/js/list-controller.js");
...
const projectController = (() => {
    ...
    function showActiveProject() {
        const project = _project_structurer__WEBPACK_IMPORTED_MODULE_0__.projectStructurer.activeProject
        const projectPage = _dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.createProjectPage(project)
        _list_controller__WEBPACK_IMPORTED_MODULE_5__.listController.setListEventListeners(projectPage, _todo_controller__WEBPACK_IMPORTED_MODULE_4__.todoController.createTodo, _todo_controller__WEBPACK_IMPORTED_MODULE_4__.todoController.setupTodoListeners)
        _dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.projectWindow.innerHTML = ""
        _dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.projectWindow.appendChild(projectPage)
    }

    function showAllTodoDateRange(startDate, endDate){
        _dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.projectWindow.innerHTML = ""
        const content = _dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.createAllProjectsPage(_project_structurer__WEBPACK_IMPORTED_MODULE_0__.projectStructurer)
        Object.values(_project_structurer__WEBPACK_IMPORTED_MODULE_0__.projectStructurer.container).forEach((project) => {
            ...
            Object.values(project.container).forEach((todo) => {
                const todoDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(todo.date, 'yyyy-MM-dd', new Date())
                if (arguments.length == 2){
                    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(todoDate, endDate) || (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(todoDate, startDate) || todo.date == ""){
                        ul.removeChild(todo.liElement)
                    }
                }
                if (arguments.length == 1){
                    if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(todoDate, startDate)){
                        ul.removeChild(todo.liElement)
                    }
                }
            })
            if (ul.childNodes.length == 0){
                _dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.hideElement(h1)
            }
        })
        _dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.projectWindow.appendChild(content)
    }

    function chooseProject() {
        const title = this.querySelector("span").textContent
        const project = _project_structurer__WEBPACK_IMPORTED_MODULE_0__.projectStructurer.getObjectByTitle(title)
        _project_structurer__WEBPACK_IMPORTED_MODULE_0__.projectStructurer.activeProject = project
        _dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.selectObjectElement(project.liElement, "project")
        showActiveProject()
    }

    function setupRemoveIcon(project){
        const element = project.liElement
        const removeIcon = _dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.getLiInterface(element).removeIcon
        removeIcon.addEventListener("click", (event) => {
            event.stopPropagation()
            const ul = event.target.closest("ul")
            _object_manipulator__WEBPACK_IMPORTED_MODULE_3__.objectManipulator.removeObject(project, ul)
            if (element.classList.contains(`${_selectorHolder__WEBPACK_IMPORTED_MODULE_2__.selectorHolder.selected}`)) chooseProject.bind(_dom_interfacer__WEBPACK_IMPORTED_MODULE_1__.domInterfacer.inbox)()
        })
    }
...
function createProject(parametersObject) {
    ...
    const proto2 = (0,_base_object__WEBPACK_IMPORTED_MODULE_1__.createBaseObject)("project", title, _images_project_png__WEBPACK_IMPORTED_MODULE_2__, _dom_interfacer__WEBPACK_IMPORTED_MODULE_3__.domInterfacer.createListElement)
...
/* harmony import */ var _todo_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todo-controller */ "./src/js/todo-controller.js");
...
/* harmony import */ var _todo_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./todo-controller */ "./src/js/todo-controller.js");
    ...
    function populateStorage(){
        ...
        function populateContainer(){
            ...
            Object.keys(projects).forEach((title) => {
                const project = (0,_project_object__WEBPACK_IMPORTED_MODULE_2__.createProject)({title})
                _project_controller__WEBPACK_IMPORTED_MODULE_1__.projectController.setProjectListeners(project)
                ...
                Object.values(projects[title]).forEach((todoParams) => {
                    const todo = _todo_controller__WEBPACK_IMPORTED_MODULE_3__.todoController.createTodo(todoParams)
                    _todo_controller__WEBPACK_IMPORTED_MODULE_3__.todoController.setupTodoListeners(todo)
...
/* harmony import */ var _object_manipulator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./object-manipulator */ "./src/js/object-manipulator.js");
/* harmony import */ var _dom_interfacer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dom-interfacer */ "./src/js/dom-interfacer.js");
...
const todoController = (() => {
    ...
    function setupRemoveIcon(todo){
        ...
        const removeIcon = _dom_interfacer__WEBPACK_IMPORTED_MODULE_5__.domInterfacer.getLiInterface(element).removeIcon
        removeIcon.addEventListener("click", (event) => {
            event.stopPropagation()
            const ul = event.target.closest("ul")
            _object_manipulator__WEBPACK_IMPORTED_MODULE_4__.objectManipulator.removeObject(todo, ul)
            _storage__WEBPACK_IMPORTED_MODULE_6__.storage.populateStorage()
        })
    }
    ...
    function setupTitleInput(todo, liInterface){
        ...
        title.addEventListener("click", (event) => {
            event.stopPropagation()
            _dom_interfacer__WEBPACK_IMPORTED_MODULE_5__.domInterfacer.replaceElement(titleInput, title)
        ...
        titleInput.addEventListener("keydown", (event) => {
            ...
            if (event.key == "Enter"){
                ...
                _dom_interfacer__WEBPACK_IMPORTED_MODULE_5__.domInterfacer.replaceElement(title, titleInput)
                _storage__WEBPACK_IMPORTED_MODULE_6__.storage.populateStorage()
            }
        })
    }
    ...
    function setupTodoIcon(liIcon, todo){
        liIcon.addEventListener("click", (event) => {
            const li = event.target.closest("li")
            if (todo.isFinished){
                _dom_interfacer__WEBPACK_IMPORTED_MODULE_5__.domInterfacer.unfinishTodo(li)
                todo.isFinished = false
            }
            else {
                todo.isFinished = true
                _dom_interfacer__WEBPACK_IMPORTED_MODULE_5__.domInterfacer.finishTodo(li)
            }
            _storage__WEBPACK_IMPORTED_MODULE_6__.storage.populateStorage()
        })
    }
    ...
    function setupTodoListeners(todo){
        ...
        const liInterface = _dom_interfacer__WEBPACK_IMPORTED_MODULE_5__.domInterfacer.getLiInterface(todoElement)
...
function createTodo(parametersObject) {
    ...
    const proto = (0,_base_object__WEBPACK_IMPORTED_MODULE_0__.createBaseObject)("todo", title, _images_unfinished_task_png__WEBPACK_IMPORTED_MODULE_1__, _dom_interfacer__WEBPACK_IMPORTED_MODULE_2__.domInterfacer.createTodoListElement.bind(parametersObject))
...
/* harmony import */ var _project_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project-controller */ "./src/js/project-controller.js");
/* harmony import */ var _list_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list-controller */ "./src/js/list-controller.js");
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/nextMonday/index.js");
/* harmony import */ var _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dom-interfacer */ "./src/js/dom-interfacer.js");
/* harmony import */ var _project_structurer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./project-structurer */ "./src/js/project-structurer.js");
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./storage */ "./src/js/storage.js");
...
function setStartPage() {
    ...
    if(localStorage.getItem("projects")) {
        _storage__WEBPACK_IMPORTED_MODULE_6__.storage.populateContainer()
        const newProjectList = _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.createList(_project_structurer__WEBPACK_IMPORTED_MODULE_5__.projectStructurer)
        newProjectList.querySelector(".cInbox").classList.add("hidden")
        const addBtn = _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.createAddBtn("project")
        const addPopup = _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.createAddPopup("project")
        const h2 = document.createElement("h2");
        h2.textContent = "Projects"
        const menu = document.querySelector(".menu")
        newProjectList.prepend(h2)
        newProjectList.append(addBtn, addPopup)
        menu.removeChild(_dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.projectList)
        menu.appendChild(newProjectList)
        _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.projectList = newProjectList
    }

    _list_controller__WEBPACK_IMPORTED_MODULE_2__.listController.setListEventListeners(_dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.projectList, _project_object__WEBPACK_IMPORTED_MODULE_3__.createProject, _project_controller__WEBPACK_IMPORTED_MODULE_1__.projectController.setProjectListeners)

    const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])()
    _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.thisWeek.addEventListener("click", (event) => {
        const li = event.target.closest("li")
        _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.selectObjectElement(li, "project")
        _project_controller__WEBPACK_IMPORTED_MODULE_1__.projectController.showAllTodoDateRange((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(today, { weekStartsOn: 1 }), (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(today))
    })
    _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.today.addEventListener("click", (event) => {
        const li = event.target.closest("li")
        _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.selectObjectElement(li, "project")
        _project_controller__WEBPACK_IMPORTED_MODULE_1__.projectController.showAllTodoDateRange(today)
    })
    _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.inbox.addEventListener("click", (event) => {
        _project_controller__WEBPACK_IMPORTED_MODULE_1__.projectController.chooseProject.call(_dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.inbox)
        const li = event.target.closest("li")
        _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.selectObjectElement(li, "project")  
    })

    _dom_interfacer__WEBPACK_IMPORTED_MODULE_4__.domInterfacer.inbox.click()
}
